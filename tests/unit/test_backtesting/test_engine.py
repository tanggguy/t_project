...
class TestBacktestEngine:
    ...
    def test_setup_broker_percentage_commission(self, engine_instance, mock_settings):
        ...
        engine_instance.cerebro.broker.setcommission.assert_called_with(
            commission=0.005
        )
    ...
    def test_add_data_success(self, engine_instance, sample_dataframe):
        ...
        with patch("backtesting.engine.bt.feeds.PandasData") as mock_pandas_data:
            ...
            engine_instance.cerebro.adddata.assert_called_once_with(
                mock_feed, name="test_data"
            )
    ...
    def test_add_data_invalid_index(self, engine_instance):
        ...
        with pytest.raises(
            ValueError, match="L'index du DataFrame doit être de type DatetimeIndex"
        ):
    ...
    def test_add_strategy(self, engine_instance, mock_strategy):
        ...
        engine_instance.cerebro.addstrategy.assert_called_once_with(
    ...
    def test_add_resampled_data_success(self, engine_instance, sample_dataframe):
        ...
        with patch("backtesting.engine.resample_data", return_value=df_resampled):
            with patch.object(engine_instance, "add_data") as mock_add_data:
                ...
                mock_add_data.assert_called_once_with(
                    df_resampled, name="resampled_weekly"
                )
